    ...
    remove(prefix:Buffer, start:number, size:number) : boolean {
        ...
        if (nextNode.isRedundant) {
            if (this.count === 1) {
                ...
                this.count = 0
                this.liveNodes--
                console.assert(this.liveNodes == 0,"this.liveNodes == 0")
            } else {
                this.next[currentCharacter - this.minCharacter] = null
                console.assert(this.liveNodes > 1,"this.liveNodes > 1")
                this.liveNodes--
                ...
                if (currentCharacter == this.minCharacter) {
                    ...
                    console.assert(newMin != this.minCharacter,"newMin != this.minCharacter")
                    console.assert(newMin > this.minCharacter,"newMin > this.minCharacter")
                    console.assert(this.count > newMin - this.minCharacter,"this.count > newMin - this.minCharacter")
                    ...
                    console.assert(newCount != this.count,"newCount != this.count")
                    this.count = newCount
